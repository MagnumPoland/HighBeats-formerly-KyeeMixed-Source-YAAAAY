...
class TitleState extends MusicBeatState
{
	...
	var easterEggKeys:Array<String> = [
		'SHADOW', 'RIVER', 'SHUBS', 'BBPANZU', 'SOMETHINGVERYOLD'
	];
	...
	override public function create():Void
	{
		...
		//nwm po co to ale dobra
		DiscordClient.changePresence("Loading game...", null);	
	...
	function startIntro()
	{
		...
		switch(easterEgg.toUpperCase())
		{
			...
			case 'SOMETHINGVERYOLD':
				...
				logoBl.frames = Paths.getSparrowAtlas('kyeeOLDLOLSOBADXD');
		...
		if (!skippedIntro)
		{
			if (playJingle) //Ignore deez
			{
				...
				switch(easteregg)
				{
					...
					case 'SOMETHINGVERYOLD':
						sound = FlxG.sound.play(Paths.sound('JingleKyee'));
