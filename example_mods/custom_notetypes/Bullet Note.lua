function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Bullet Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'customNOTES/BULLET'); --Change texture
			setPropertyFromGroup('unspawnNotes', i, 'multSpeed', 1.15); --Change note speed (holy shit 0.6 is good)
