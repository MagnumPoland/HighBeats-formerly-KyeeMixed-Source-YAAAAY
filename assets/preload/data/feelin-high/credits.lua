...
--IF YOU ARE NOT USING CERTAIN NAME SLOTS, JUST LEAVE THEM BLANK 
	...
	MusicianName1 = 'Og Song: tATu - Nas Ne Dogonyat'
	MusicianName2 = 'Cover maker - Pf0r'
	MusicianName3 = ''
...
CreditsExitTimer = 3 --How many seconds the script will show before exiting

TweenSpeed = 1 --How fast the credits move in/out

Transparency = 0.7 --I wouldn't mess with this, but it changes the transparency of the credits underlay

Font = 'vcr.ttf' --Change the Font here if needed

HorizontalUnderLayOffset = 10  --Moves Underlay if needed (horizontally)
--POSITIVE MOVES LEFT
--NEGATIVE MOVES RIGHT

HorizontalWordsOffset = -15 --Moves the words if needed (horizontally)
--NEGATIVE MOVES LEFT
